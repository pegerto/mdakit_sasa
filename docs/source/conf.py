...
htmlhelp_basename = "mdakit_sasadoc"
...
latex_documents = [
    (master_doc, "mdakit_sasa.tex", "mdakit-sasa Documentation",
     "mdakit_sasa", "manual"),
]
...
man_pages = [
    (master_doc, "mdakit_sasa", "mdakit-sasa Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "mdakit_sasa", "mdakit-sasa Documentation",
     author, "mdakit_sasa", "This kit allows the calculation of a solvent-accessible-surface area of a trajectory",
     "Miscellaneous"),
]
