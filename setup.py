...
short_description = "This kit allows the calculation of a solvent-accessible-surface area of a trajectory".strip().split("\n")[0]
...
setup(
    ...
    author_email='pegerto.fernandez@brunel.ac.uk',
    ...
    # url='mdakit_sasa.readthedocs.io/en/latest/',  # Website
    # platforms=['Linux',
    #            'Mac OS-X',
    #            'Unix',
